// Metadados estaticos e leves dos livros (para grades do modal) - nao editar manualmente
// Gerado por script a partir de src/data/books/*.json
export const BOOK_META = {
  ...
  "jz": {
    name: "Juízes",
    chaptersCount: 21,
    versesPerChapter: [36,23,31,24,32,40,25,35,57,18,40,15,25,20,20,31,13,31,30,48,25],
  },
  "rt": {
    name: "Rute",
    chaptersCount: 4,
  ...
  "1sm": {
    name: "1 Samuel",
    chaptersCount: 31,
    versesPerChapter: [28,36,21,22,12,21,17,22,27,27,15,25,23,52,35,23,58,30,24,43,15,23,29,22,44,25,12,25,11,31,13],
  },
  "2sm": {
    name: "2 Samuel",
    chaptersCount: 24,
  ...
  "1rs": {
    name: "1 Reis",
    chaptersCount: 22,
    versesPerChapter: [53,46,28,34,18,38,51,66,28,29,43,33,34,31,34,34,24,46,21,43,29,54],
  },
  "2rs": {
    name: "2 Reis",
    chaptersCount: 25,
...
export function getBookMeta(abbrev) {
  return BOOK_META[abbrev] || null;
}
